...
def build_prompt(category: str, family_key: str) -> str:
    ...
    descriptions = {
        ...
        "ram_ddr4": "a single desktop DDR4 memory module with a low-profile black heatspreader",
        "ram_ddr5": "a single desktop DDR5 memory module with a black heatspreader",
