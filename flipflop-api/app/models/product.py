...
class Product(Base):
    ...
    item_specifics = Column(JSON, nullable=False, default=dict)
    platform_category_id = Column(String(30), nullable=True)
    platform_category_name = Column(String(150), nullable=True)
