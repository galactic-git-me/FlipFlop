...
from app.api.bot_approvals import router as bot_approvals_router, bot_router as bot_ingest_router
...
app.include_router(bot_approvals_router, prefix="/api")
app.include_router(bot_ingest_router, prefix="/api")
...
async def _migrate_add_columns():
    ...
    new_cols = [
        ...
        ("manual_builds", "ebay_listing_status",     "VARCHAR(20) DEFAULT 'never_listed'"),
        ("manual_builds", "ebay_listing_status_checked_at", "TIMESTAMP"),
        ("manual_builds", "ebay_listing_end_reason", "VARCHAR(40)"),
