"""Score all unscored listings to improve priced metric baseline."""
...
async def score_all_unscored(limit: int | None = None):
    ...
    async with AsyncSessionLocal() as db:
        ...
        total = len(listings)
        print(f"Scoring {total} unscored listings...")
        print()
