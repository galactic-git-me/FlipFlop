...
- Location: tests\e2e\cross-listing.spec.ts:123:5
...
Expected: visible
Error: strict mode violation: getByText('Atlas Gaming PC RTX 3060') resolved to 2 elements:
    1) <div class="truncate font-medium text-slate-100">Atlas Gaming PC RTX 3060</div> aka getByText('Atlas Gaming PC RTX').first()
    2) <div class="truncate font-medium text-slate-100">Atlas Gaming PC RTX 3060</div> aka getByText('Atlas Gaming PC RTX').nth(1)
