(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,22410,i=>{"use strict";var e=i.i(43476);i.s(["default",0,function(){let i=`
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  `;return(0,e.jsx)("div",{className:"min-h-screen bg-slate-900 p-6",children:(0,e.jsxs)("div",{className:"max-w-4xl mx-auto",children:[(0,e.jsxs)("div",{className:"mb-6",children:[(0,e.jsx)("h1",{className:"text-3xl font-bold text-white mb-2",children:"eBay Listing Preview"}),(0,e.jsx)("p",{className:"text-slate-400",children:"This is what your beautiful HTML listing looks like when published to eBay"})]}),(0,e.jsx)("div",{className:"bg-white rounded-lg shadow-2xl overflow-hidden",children:(0,e.jsx)("iframe",{srcDoc:i,className:"w-full h-screen border-0",title:"eBay Listing Preview"})})]})})}])}]);